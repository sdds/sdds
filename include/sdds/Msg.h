...
rc_t
Msg_init(Msg_t* _this, Data dataBuffer);
rc_t
Msg_getData(Msg_t* _this, Data* data);
// abstract -> impl in generated file
size_t
Msg_getSize(Msg_t* _this);

#if defined(SDDS_TOPIC_HAS_PUB) || defined(FEATURE_SDDS_BUILTIN_TOPICS_ENABLED)
rc_t
MsgPool_getFreeMsg(struct MsgPool* _this, Msg_t** msg);
rc_t
MsgPool_getNextMsg(struct MsgPool* _this, Msg_t** msg);
rc_t
MsgPool_getUnreadMsgCount(struct MsgPool* _this, uint8_t* count);
#endif
