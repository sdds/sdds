...
IMPL_DEPEND_OBJS = $(SDDS_OBJDIR)/messung6_linux_sdds_impl.o
ALL_OBJS += $(IMPL_DEPEND_OBJS)
ALL_OBJS += $(SDDS_OBJDIR)/messung6_linux.o

SDDS_CONSTANTS_FILE := ./gen_constants.h

include $(SDDS_TOPDIR)/sdds.mk

DATA_DEPEND_OBJS += $(SDDS_OBJDIR)/delta-ds.o
DATA_DEPEND_OBJS += $(SDDS_OBJDIR)/gamma-ds.o
...
$(APPLICATION_NAME): $(SDDS_OBJDIR)/messung6_linux.o $(SDDS_OBJS) $(IMPL_DEPEND_OBJS) $(DATA_DEPEND_OBJS)
	$(CC) -o $@ $^ $(LDLIBS)
