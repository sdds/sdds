...
IMPL_DEPEND_OBJS = $(SDDS_OBJDIR)/messung3_linux_sdds_impl.o
ALL_OBJS += $(IMPL_DEPEND_OBJS)
ALL_OBJS += $(SDDS_OBJDIR)/messung3_linux.o
...
$(APPLICATION_NAME): $(SDDS_OBJDIR)/messung3_linux.o $(SDDS_OBJS) $(IMPL_DEPEND_OBJS) $(DATA_DEPEND_OBJS)
	$(CC) -o $@ $^ $(LDLIBS)
