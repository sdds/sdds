...
IMPL_DEPEND_OBJS = $(SDDS_OBJDIR)/sdds_app2_sdds_impl.o
IMPL_DEPEND_OBJS += $(SDDS_OBJDIR)/sdds_app2_shm.o
ALL_OBJS += $(IMPL_DEPEND_OBJS)
ALL_OBJS += $(SDDS_OBJDIR)/sdds_app2.o
...
lib$(APPLICATION_NAME).a: $(SDDS_OBJDIR)/sdds_app2.o $(SDDS_OBJS) $(IMPL_DEPEND_OBJS) $(DATA_DEPEND_OBJS)
	$(AR) cr $@ $^ $(LDLIBS)
