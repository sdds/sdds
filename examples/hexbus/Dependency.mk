...
APPLICATION_DEPEND_OBJS += $(SDDS_OBJDIR)/Wiedas_SensorApp_OnOffOutput.o
APPLICATION_DEPEND_OBJS += $(SDDS_OBJDIR)/Wiedas_SensorApp_PowerMeter.o
#APPLICATION_DEPEND_OBJS += $(SDDS_OBJDIR)/Wiedas_SensorApp_SimpleLamp.o
