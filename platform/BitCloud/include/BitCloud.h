...
#define SDDS_ZIGBEE_APP_ENDPOINT_ID	0x0a
#define SDDS_ZIGBEE_APP_PROFILE_ID	0x0F04
#define SDDS_ZIGBEE_APP_CLUSTER_ID	1
#define SDDS_ZIGBEE_APP_DEVICE_ID	1
#define SDDS_ZIGBEE_APP_DEVICE_VERSION	1
