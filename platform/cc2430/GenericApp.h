...
#define PLATFORM_CC2430_GENERICAPP_SEND_MSG_TIMEOUT   5000     // Every 5 seconds
...
extern void ZigBee_init( byte task_id );

/*
 * Task Event Processor for the Generic Application
 */
extern UINT16 GenericApp_ProcessEvent( byte task_id, UINT16 events );
extern UINT16 ZigBee_ProcessEvent( byte task_id, UINT16 events );
