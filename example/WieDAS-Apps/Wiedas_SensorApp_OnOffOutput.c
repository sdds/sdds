/*
 * Wiedas_SensorApp_OnOffOutput.c
 *
...
rc_t Wiedas_SensorApp_OnOffOutput_dowork() {
	...
	DDS_ReturnCode_t ret = DDS_OnOffOutputDataWriter_write(g_OnOffOutput_writer,
			&sw, NULL );
