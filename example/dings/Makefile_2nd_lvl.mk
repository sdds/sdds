...
IMPL_DEPEND_OBJS = $(SDDS_OBJDIR)/dings_sdds_impl.o
ALL_OBJS += $(IMPL_DEPEND_OBJS)
ALL_OBJS += $(SDDS_OBJDIR)/dings.o
...
$(APPLICATION_NAME): $(SDDS_OBJDIR)/dings.o $(SDDS_OBJS) $(IMPL_DEPEND_OBJS) $(DATA_DEPEND_OBJS)
	$(CC) -o $@ $^ $(LDLIBS)
