...
DDS_Topic g_Gamma_topic;
Gamma g_Gamma_pool[SDDS_TOPIC_APP_MSG_COUNT];
DDS_DataReader g_Gamma_reader;

DDS_Topic g_Delta_topic;
Delta g_Delta_pool[SDDS_TOPIC_APP_MSG_COUNT];
DDS_DataReader g_Delta_reader;
...
rc_t sDDS_init(void)
{
	...
	g_Gamma_topic = sDDS_GammaTopic_create(g_Gamma_pool, SDDS_TOPIC_APP_MSG_COUNT);
	g_Gamma_reader = DataSink_create_datareader(g_Gamma_topic, NULL, NULL /*&sdds_listener*/, NULL);

	g_Delta_topic = sDDS_DeltaTopic_create(g_Delta_pool, SDDS_TOPIC_APP_MSG_COUNT);
	g_Delta_reader = DataSink_create_datareader(g_Delta_topic, NULL, NULL /*&sdds_listener*/, NULL);
