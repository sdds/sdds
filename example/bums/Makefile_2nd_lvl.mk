...
IMPL_DEPEND_OBJS = $(SDDS_OBJDIR)/bums_sdds_impl.o
ALL_OBJS += $(IMPL_DEPEND_OBJS)
ALL_OBJS += $(SDDS_OBJDIR)/bums.o
...
$(APPLICATION_NAME): $(SDDS_OBJDIR)/bums.o $(SDDS_OBJS) $(IMPL_DEPEND_OBJS) $(DATA_DEPEND_OBJS)
	$(CC) -o $@ $^ $(LDLIBS)
