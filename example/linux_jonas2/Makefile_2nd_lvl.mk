...
IMPL_DEPEND_OBJS = $(SDDS_OBJDIR)/linux_jonas2_sdds_impl.o
ALL_OBJS += $(IMPL_DEPEND_OBJS)
ALL_OBJS += $(SDDS_OBJDIR)/linux_jonas2.o
...
$(APPLICATION_NAME): $(SDDS_OBJDIR)/linux_jonas2.o $(SDDS_OBJS) $(IMPL_DEPEND_OBJS) $(DATA_DEPEND_OBJS)
	$(CC) -o $@ $^ $(LDLIBS)
